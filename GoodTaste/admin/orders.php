...
<div class="wrapper" style="background-color:#4b4b4b">
    ...
    <div class="main-panel">
                        ...
                        <div class="card">
							...
							<div class="row">
								...
								<div class="col-md-12" >
									...
									<div class="col-md-3" style="text-align: center; background: #4b4b4b; color: #fff; border-right: 1px solid #fff;">
									
										<h5>ORDER ID</h5>
										
									</div>
									
									<div class="col-md-9" style="background: #4b4b4b; color: #fff;">
        ...
        <footer class="footer">
			...
			<p class="copyright pull-right">
                    &copy; 2020 <a href="index.php" style="color: #FF5722;">GoodTaste</a>
                </p>
                </p>
            </div>
        </footer>
