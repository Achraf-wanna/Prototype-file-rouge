			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<div class ="frame">
  							  <a href="https://www.facebook.com" target="_blank" class="btntt">
 									<i class="fab fa-facebook-f" style="color: #3b5998;"></i>
								</a>
   							<a href="https://twitter.com" target="_blank" class="btntt">
								<i class="fab fa-twitter" style="color: #00acee;"></i>
								</a>
									<a href="https://dribbble.com" target="_blank" class="btntt">
								<i class="fab fa-dribbble" style="color: #ea4c89;"></i>
								</a>
									<a href="http://linkedin.com" target="_blank" class="btntt">
								<i class="fab fa-linkedin-in" style="color:#0e76a8;"></i>
								</a>
									<a href="https://getpocket.com"  target="_blank" class="btntt">
								<i class="fab fa-get-pocket" style="color:#ee4056;"></i>
								</a>
									<a href="https://gmail.com" target="_blank" class="btntt">
